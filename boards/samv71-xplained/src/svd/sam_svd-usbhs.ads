...
package SAM_SVD.USBHS is
   ...
   --  Mode Configuration
   type USBHS_DEVCTRL_SPDCONFSelect is
...
--  capability.
      FORCED_FS)
     with Size => 2;
   for USBHS_DEVCTRL_SPDCONFSelect use
     (NORMAL => 0,
      LOW_POWER => 1,
      HIGH_SPEED => 2,
      FORCED_FS => 3);
   ...
   type USBHS_USBHS_DEVCTRL_Register is record
      ...
      --  Mode Configuration
      SPDCONF        : USBHS_DEVCTRL_SPDCONFSelect := SAM_SVD.USBHS.NORMAL;
   ...
   --  Endpoint Banks
   type USBHS_DEVEPTCFG_EPBKSelect is
     (--  Single-bank endpoint
      ...
      Val_3_BANK)
     with Size => 2;
   for USBHS_DEVEPTCFG_EPBKSelect use
     (Val_1_BANK => 0,
      Val_2_BANK => 1,
      Val_3_BANK => 2);

   --  Endpoint Size
   type USBHS_DEVEPTCFG_EPSIZESelect is
     (--  8 bytes
      Val_8_BYTE,
      --  16 bytes
      Val_16_BYTE,
      ...
      Val_1024_BYTE)
     with Size => 3;
   for USBHS_DEVEPTCFG_EPSIZESelect use
     (Val_8_BYTE => 0,
      Val_16_BYTE => 1,
      Val_32_BYTE => 2,
      Val_64_BYTE => 3,
   ...
   --  Endpoint Direction
   type USBHS_DEVEPTCFG_EPDIRSelect is
     (--  The endpoint direction is OUT.
      OUT_k,
      --  The endpoint direction is IN (nor for control endpoints).
      IN_k)
     with Size => 1;
   for USBHS_DEVEPTCFG_EPDIRSelect use
     (OUT_k => 0,
      IN_k => 1);

   --  Endpoint Type
   type USBHS_DEVEPTCFG_EPTYPESelect is
     (--  Control
      CTRL,
      --  Isochronous
      ISO,
      ...
      INTRPT)
     with Size => 2;
   for USBHS_DEVEPTCFG_EPTYPESelect use
     (CTRL => 0,
      ISO => 1,
      BLK => 2,
      INTRPT => 3);
   ...
   type USBHS_DEVEPTCFG_NBTRANSSelect is
...
--  triple-bank.
      Val_3_TRANS)
     with Size => 2;
   for USBHS_DEVEPTCFG_NBTRANSSelect use
     (Val_0_TRANS => 0,
      Val_1_TRANS => 1,
      Val_2_TRANS => 2,
      Val_3_TRANS => 3);
   ...
   type USBHS_USBHS_DEVEPTCFG_Register is record
      ...
      ALLOC          : Boolean := False;
      --  Endpoint Banks
      EPBK           : USBHS_DEVEPTCFG_EPBKSelect := SAM_SVD.USBHS.Val_1_BANK;
      --  Endpoint Size
      EPSIZE         : USBHS_DEVEPTCFG_EPSIZESelect :=
                        SAM_SVD.USBHS.Val_8_BYTE;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Endpoint Direction
      EPDIR          : USBHS_DEVEPTCFG_EPDIRSelect := SAM_SVD.USBHS.OUT_k;
      --  Automatic Switch
      AUTOSW         : Boolean := False;
      --  unspecified
      Reserved_10_10 : HAL.Bit := 16#0#;
      --  Endpoint Type
      EPTYPE         : USBHS_DEVEPTCFG_EPTYPESelect := SAM_SVD.USBHS.CTRL;
      --  Number of transactions per microframe for isochronous endpoint
      NBTRANS        : USBHS_DEVEPTCFG_NBTRANSSelect :=
   ...
   type USBHS_DEVEPTISR_DTSEQSelect is
     (--  Data0 toggle sequence
      ...
      MDATA)
     with Size => 2;
   for USBHS_DEVEPTISR_DTSEQSelect use
     (DATA0 => 0,
      DATA1 => 1,
      DATA2 => 2,
      MDATA => 3);
   ...
   type USBHS_DEVEPTISR_NBUSYBKSelect is
     (--  0 busy bank (all banks free)
      ...
      Val_3_BUSY)
     with Size => 2;
   for USBHS_DEVEPTISR_NBUSYBKSelect use
     (Val_0_BUSY => 0,
      Val_1_BUSY => 1,
      Val_2_BUSY => 2,
      Val_3_BUSY => 3);
   ...
   --  Current Bank
   type USBHS_DEVEPTISR_CURRBKSelect is
     (--  Current bank is bank0
      ...
      BANK2)
     with Size => 2;
   for USBHS_DEVEPTISR_CURRBKSelect use
     (BANK0 => 0,
      BANK1 => 1,
      BANK2 => 2);
   ...
   type USBHS_USBHS_DEVEPTISR_Register is record
      ...
      DTSEQ          : USBHS_DEVEPTISR_DTSEQSelect;
      --  unspecified
      Reserved_10_11 : HAL.UInt2;
      --  Read-only. Number of Busy Banks
      NBUSYBK        : USBHS_DEVEPTISR_NBUSYBKSelect;
      --  Read-only. Current Bank
      CURRBK         : USBHS_DEVEPTISR_CURRBKSelect;
   ...
   --  Mode Configuration
   type USBHS_HSTCTRL_SPDCONFSelect is
...
--  capability.
      FORCED_FS)
     with Size => 2;
   for USBHS_HSTCTRL_SPDCONFSelect use
     (NORMAL => 0,
      LOW_POWER => 1,
      HIGH_SPEED => 2,
      FORCED_FS => 3);
   ...
   type USBHS_USBHS_HSTCTRL_Register is record
      ...
      --  Mode Configuration
      SPDCONF        : USBHS_HSTCTRL_SPDCONFSelect := SAM_SVD.USBHS.NORMAL;
      --  unspecified
   ...
   --  Pipe Banks
   type USBHS_HSTPIPCFG_PBKSelect is
     (--  Single-bank pipe
      Val_1_BANK,
      --  Double-bank pipe
      Val_2_BANK,
      ...
      Val_3_BANK)
     with Size => 2;
   for USBHS_HSTPIPCFG_PBKSelect use
     (Val_1_BANK => 0,
      Val_2_BANK => 1,
      Val_3_BANK => 2);

   --  Pipe Size
   type USBHS_HSTPIPCFG_PSIZESelect is
     (--  8 bytes
      Val_8_BYTE,
      --  16 bytes
      Val_16_BYTE,
      ...
      Val_1024_BYTE)
     with Size => 3;
   for USBHS_HSTPIPCFG_PSIZESelect use
     (Val_8_BYTE => 0,
      Val_16_BYTE => 1,
      Val_32_BYTE => 2,
      Val_64_BYTE => 3,
   ...
   --  Pipe Token
   type USBHS_HSTPIPCFG_PTOKENSelect is
     (--  SETUP
      SETUP,
      --  IN
      IN_k,
      ...
      OUT_k)
     with Size => 2;
   for USBHS_HSTPIPCFG_PTOKENSelect use
     (SETUP => 0,
      IN_k => 1,
      OUT_k => 2);

   --  Pipe Type
   type USBHS_HSTPIPCFG_PTYPESelect is
     (--  Control
      CTRL,
      --  Isochronous
      ISO,
      ...
      INTRPT)
     with Size => 2;
   for USBHS_HSTPIPCFG_PTYPESelect use
     (CTRL => 0,
      ISO => 1,
      BLK => 2,
      INTRPT => 3);
   ...
   type USBHS_USBHS_HSTPIPCFG_Register is record
      ...
      ALLOC          : Boolean := False;
      --  Pipe Banks
      PBK            : USBHS_HSTPIPCFG_PBKSelect := SAM_SVD.USBHS.Val_1_BANK;
      --  Pipe Size
      PSIZE          : USBHS_HSTPIPCFG_PSIZESelect :=
                        SAM_SVD.USBHS.Val_8_BYTE;
      --  unspecified
      Reserved_7_7   : HAL.Bit := 16#0#;
      --  Pipe Token
      PTOKEN         : USBHS_HSTPIPCFG_PTOKENSelect := SAM_SVD.USBHS.SETUP;
      --  Automatic Switch
      AUTOSW         : Boolean := False;
      --  unspecified
      Reserved_11_11 : HAL.Bit := 16#0#;
      --  Pipe Type
      PTYPE          : USBHS_HSTPIPCFG_PTYPESelect := SAM_SVD.USBHS.CTRL;
      --  unspecified
      Reserved_14_15 : HAL.UInt2 := 16#0#;
   ...
   --  Data Toggle Sequence
   type USBHS_HSTPIPISR_DTSEQSelect is
     (--  Data0 toggle sequence
      DATA0,
      --  Data1 toggle sequence
      DATA1)
     with Size => 2;
   for USBHS_HSTPIPISR_DTSEQSelect use
     (DATA0 => 0,
      DATA1 => 1);

   --  Number of Busy Banks
   type USBHS_HSTPIPISR_NBUSYBKSelect is
     (--  0 busy bank (all banks free)
      Val_0_BUSY,
      --  1 busy bank
      Val_1_BUSY,
      ...
      Val_3_BUSY)
     with Size => 2;
   for USBHS_HSTPIPISR_NBUSYBKSelect use
     (Val_0_BUSY => 0,
      Val_1_BUSY => 1,
      Val_2_BUSY => 2,
      Val_3_BUSY => 3);
   ...
   --  Current Bank
   type USBHS_HSTPIPISR_CURRBKSelect is
     (--  Current bank is bank0
      BANK0,
      --  Current bank is bank1
      BANK1,
      ...
      BANK2)
     with Size => 2;
   for USBHS_HSTPIPISR_CURRBKSelect use
     (BANK0 => 0,
      BANK1 => 1,
      BANK2 => 2);
   ...
   type USBHS_USBHS_HSTPIPISR_Register is record
      ...
      --  Read-only. Data Toggle Sequence
      DTSEQ          : USBHS_HSTPIPISR_DTSEQSelect;
      --  unspecified
      Reserved_10_11 : HAL.UInt2;
      --  Read-only. Number of Busy Banks
      NBUSYBK        : USBHS_HSTPIPISR_NBUSYBKSelect;
      --  Read-only. Current Bank
      CURRBK         : USBHS_HSTPIPISR_CURRBKSelect;
      --  Read-only. Read/Write Allowed
      RWALL          : Boolean;
      --  unspecified
   ...
   type USBHS_USBHS_CTRL_Register is record
      ...
      UID            : Boolean := False;
      --  USBHS Mode
      UIMOD          : USBHS_CTRL_UIMODSelect := SAM_SVD.USBHS.HOST;
      --  unspecified
      Reserved_26_31 : HAL.UInt6 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   type USBHS_FSM_DRDSTATESelect is
...
--  protocol.
      B_SRP_INIT)
     with Size => 4;
   for USBHS_FSM_DRDSTATESelect use
     (A_IDLESTATE => 0,
      A_WAIT_VRISE => 1,
      A_WAIT_BCON => 2,
      A_HOST => 3,
   ...
   type USBHS_USBHS_FSM_Register is record
      ...
      DRDSTATE      : USBHS_FSM_DRDSTATESelect;
      --  unspecified
