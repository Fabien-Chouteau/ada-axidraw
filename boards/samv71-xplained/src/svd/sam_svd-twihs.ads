...
package SAM_SVD.TWIHS is
   ...
   type TWIHS_MMR_IADRSZSelect is
     (--  No internal device address
      ...
      Val_3_BYTE)
     with Size => 2;
   for TWIHS_MMR_IADRSZSelect use
     (NONE => 0,
      Val_1_BYTE => 1,
      Val_2_BYTE => 2,
      Val_3_BYTE => 3);
   ...
   type TWIHS_TWIHS_MMR_Register is record
      ...
      --  Internal Device Address Size
      IADRSZ         : TWIHS_MMR_IADRSZSelect := SAM_SVD.TWIHS.NONE;
      --  unspecified
   ...
   type TWIHS_WPMR_WPKEYSelect is
     (--  Reset value for the field
      TWIHS_WPMR_WPKEYSelect_Reset,
      --  Writing any other value in this field aborts the write operation of the
--  WPEN bit.Always reads as 0
      PASSWD)
     with Size => 24;
   for TWIHS_WPMR_WPKEYSelect use
     (TWIHS_WPMR_WPKEYSelect_Reset => 0,
      PASSWD => 5527369);
   ...
   type TWIHS_TWIHS_WPMR_Register is record
      ...
      --  Write Protection Key
      WPKEY        : TWIHS_WPMR_WPKEYSelect := TWIHS_WPMR_WPKEYSelect_Reset;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   TWIHS0_Periph : aliased TWIHS_Peripheral
     with Import, Address => TWIHS0_Base;

   --  Two-wire Interface High Speed
   TWIHS1_Periph : aliased TWIHS_Peripheral
     with Import, Address => TWIHS1_Base;

   --  Two-wire Interface High Speed
   TWIHS2_Periph : aliased TWIHS_Peripheral
     with Import, Address => TWIHS2_Base;
