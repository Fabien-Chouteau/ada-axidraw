...
package SAM_SVD.ICM is
   ...
   type ICM_ICM_CFG_Register is record
      ...
      --  User SHA Algorithm
      UALGO          : ICM_CFG_UALGOSelect := SAM_SVD.ICM.SHA1;
