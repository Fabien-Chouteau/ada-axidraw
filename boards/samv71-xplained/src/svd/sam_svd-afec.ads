...
--  software.
      ...
      EN)
     with Size => 1;
   for AFEC_MR_TRGENSelect use
     (DIS => 0,
      EN => 1);

   --  Trigger Selection
   type AFEC_MR_TRGSELSelect is
...
--  conversions.
      SLEEP)
     with Size => 1;
   for AFEC_MR_SLEEPSelect use
     (NORMAL => 0,
      SLEEP => 1);

   --  Fast Wakeup
   type AFEC_MR_FWUPSelect is
     (--  Normal Sleep mode: The sleep mode is defined by the SLEEP bit.
      OFF,
      --  Fast akeup Sleep mode: The voltage reference is ON between conversions and
--  AFE is OFF.
      ON)
     with Size => 1;
   for AFEC_MR_FWUPSelect use
     (OFF => 0,
      ON => 1);

   --  Free Run Mode
   type AFEC_MR_FREERUNSelect is
     (--  Normal mode
      OFF,
      --  Free Run mode: Never wait for any trigger.
      ON)
     with Size => 1;
   for AFEC_MR_FREERUNSelect use
     (OFF => 0,
      ON => 1);
...
--  AFEC_SEQ1R.
   ...
   type AFEC_AFEC_MR_Register is record
      --  Trigger Enable
      TRGEN          : AFEC_MR_TRGENSelect := SAM_SVD.AFEC.DIS;
      --  Trigger Selection
      TRGSEL         : AFEC_MR_TRGSELSelect := SAM_SVD.AFEC.AFEC_TRIG0;
      --  unspecified
      Reserved_4_4   : HAL.Bit := 16#0#;
      --  Sleep Mode
      SLEEP          : AFEC_MR_SLEEPSelect := SAM_SVD.AFEC.NORMAL;
      --  Fast Wakeup
      FWUP           : AFEC_MR_FWUPSelect := SAM_SVD.AFEC.OFF;
      --  Free Run Mode
      FREERUN        : AFEC_MR_FREERUNSelect := SAM_SVD.AFEC.OFF;
      --  Prescaler Rate Selection
      PRESCAL        : AFEC_AFEC_MR_PRESCAL_Field := 16#0#;
      --  Startup Time
      STARTUP        : AFEC_MR_STARTUPSelect := SAM_SVD.AFEC.SUT0;
      --  unspecified
      ...
      --  User Sequence Enable
      USEQ           : AFEC_MR_USEQSelect := SAM_SVD.AFEC.NUM_ORDER;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   --  Comparison Mode
   type AFEC_EMR_CMPMODESelect is
...
--  threshold of the window.
      ...
      OUT_k)
     with Size => 2;
   for AFEC_EMR_CMPMODESelect use
     (LOW => 0,
      HIGH => 1,
      IN_k => 2,
      OUT_k => 3);
   ...
   --  Sign Mode
   type AFEC_EMR_SIGNMODESelect is
...
--  conversions.
      ...
      ALL_SIGNED)
     with Size => 2;
   for AFEC_EMR_SIGNMODESelect use
     (SE_UNSG_DF_SIGN => 0,
      SE_SIGN_DF_UNSG => 1,
      ALL_UNSIGNED => 2,
      ALL_SIGNED => 3);
   ...
   type AFEC_AFEC_EMR_Register is record
      --  Comparison Mode
      CMPMODE        : AFEC_EMR_CMPMODESelect := SAM_SVD.AFEC.LOW;
      --  unspecified
      ...
      --  Resolution
      RES            : AFEC_EMR_RESSelect := SAM_SVD.AFEC.NO_AVERAGE;
      --  unspecified
      ...
      --  Sign Mode
      SIGNMODE       : AFEC_EMR_SIGNMODESelect :=
   ...
   type AFEC_TEMPMR_TEMPCMPMODSelect is
     (--  Generates an event when the converted data is lower than the low threshold
--  of the window.
      LOW,
      --  Generates an event when the converted data is higher than the high
--  threshold of the window.
      ...
      OUT_k)
     with Size => 2;
   for AFEC_TEMPMR_TEMPCMPMODSelect use
     (LOW => 0,
      HIGH => 1,
      IN_k => 2,
      OUT_k => 3);
   ...
   type AFEC_AFEC_TEMPMR_Register is record
      ...
      --  Temperature Comparison Mode
      TEMPCMPMOD    : AFEC_TEMPMR_TEMPCMPMODSelect := SAM_SVD.AFEC.LOW;
      --  unspecified
   ...
   --  Write Protect KEY
   type AFEC_WPMR_WPKEYSelect is
     (--  Reset value for the field
      AFEC_WPMR_WPKEYSelect_Reset,
      --  Writing any other value in this field aborts the write operation of the
--  WPEN bit. Always reads as 0.
      PASSWD)
     with Size => 24;
   for AFEC_WPMR_WPKEYSelect use
     (AFEC_WPMR_WPKEYSelect_Reset => 0,
      PASSWD => 4277315);
   ...
   type AFEC_AFEC_WPMR_Register is record
      ...
      --  Write Protect KEY
      WPKEY        : AFEC_WPMR_WPKEYSelect := AFEC_WPMR_WPKEYSelect_Reset;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
