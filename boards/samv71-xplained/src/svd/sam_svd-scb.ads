...
--  pending
   ...
   type SCB_ICSR_Register is record
      ...
      RETTOBASE      : ICSR_RETTOBASESelect := SAM_SVD.SCB.VALUE_0;
      ...
      --  Indicates whether a pending exception will be serviced on exit from
      --  debug halt state
      ISRPREEMPT     : ICSR_ISRPREEMPTSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_24_24 : HAL.Bit := 16#0#;
      --  Removes the pending status of the SysTick exception
      PENDSTCLR      : ICSR_PENDSTCLRSelect := SAM_SVD.SCB.VALUE_0;
      --  Sets the SysTick exception as pending, or reads the current state of
      --  the exception
      PENDSTSET      : ICSR_PENDSTSETSelect := SAM_SVD.SCB.VALUE_0;
      --  Removes the pending status of the PendSV exception
      PENDSVCLR      : ICSR_PENDSVCLRSelect := SAM_SVD.SCB.VALUE_0;
      --  Sets the PendSV exception as pending, or reads the current state of
      --  the exception
      PENDSVSET      : ICSR_PENDSVSETSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_29_30 : HAL.UInt2 := 16#0#;
      --  Makes the NMI exception active, or reads the state of the exception
      NMIPENDSET     : ICSR_NMIPENDSETSelect := SAM_SVD.SCB.VALUE_0;
   end record
     with Volatile_Full_Access, Object_Size => 32,
          Bit_Order => System.Low_Order_First;
   ...
   type SCB_AIRCR_Register is record
      ...
      --  System Reset Request
      SYSRESETREQ    : AIRCR_SYSRESETREQSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      ...
      --  Memory system endianness
      ENDIANNESS     : AIRCR_ENDIANNESSSelect := SAM_SVD.SCB.VALUE_0;
      --  Vector key
...
--  wakeup the processor
   ...
   type SCB_SCR_Register is record
      ...
      --  Determines whether, on an exit from an ISR that returns to the base
      --  level of execution priority, the processor enters a sleep state
      SLEEPONEXIT   : SCR_SLEEPONEXITSelect := SAM_SVD.SCB.VALUE_0;
      --  Provides a qualifying hint indicating that waking from sleep might
      --  take longer
      SLEEPDEEP     : SCR_SLEEPDEEPSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_3_3  : HAL.Bit := 16#0#;
      --  Determines whether an interrupt transition from inactive state to
      --  pending state is a wakeup event
      SEVONPEND     : SCR_SEVONPENDSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
...
--  load and store instructions
   ...
   type SCB_CCR_Register is record
      --  Controls whether the processor can enter Thread mode with exceptions
      --  active
      NONBASETHRDENA : CCR_NONBASETHRDENASelect := SAM_SVD.SCB.VALUE_0;
      --  Enables unprivileged software access to the STIR
      USERSETMPEND   : CCR_USERSETMPENDSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_2_2   : HAL.Bit := 16#0#;
      --  Enables unaligned access traps
      UNALIGN_TRP    : CCR_UNALIGN_TRPSelect := SAM_SVD.SCB.VALUE_0;
      --  Enables faulting or halting when the processor executes an SDIV or
      --  UDIV instruction with a divisor of 0
      DIV_0_TRP      : CCR_DIV_0_TRPSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_5_7   : HAL.UInt3 := 16#0#;
      --  Enables handlers with priority -1 or -2 to ignore data BusFaults
      --  caused by load and store instructions.
      BFHFNMIGN      : CCR_BFHFNMIGNSelect := SAM_SVD.SCB.VALUE_0;
      --  Indicates stack alignment on exception entry
      STKALIGN       : CCR_STKALIGNSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
   ...
   type SCB_SHCSR_Register is record
      MEMFAULTACT    : SHCSR_MEMFAULTACTSelect := SAM_SVD.SCB.VALUE_0;
      BUSFAULTACT    : SHCSR_BUSFAULTACTSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_2_2   : HAL.Bit := 16#0#;
      USGFAULTACT    : SHCSR_USGFAULTACTSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_4_6   : HAL.UInt3 := 16#0#;
      SVCALLACT      : SHCSR_SVCALLACTSelect := SAM_SVD.SCB.VALUE_0;
      MONITORACT     : SHCSR_MONITORACTSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_9_9   : HAL.Bit := 16#0#;
      PENDSVACT      : SHCSR_PENDSVACTSelect := SAM_SVD.SCB.VALUE_0;
      SYSTICKACT     : SHCSR_SYSTICKACTSelect := SAM_SVD.SCB.VALUE_0;
      USGFAULTPENDED : SHCSR_USGFAULTPENDEDSelect := SAM_SVD.SCB.VALUE_0;
      MEMFAULTPENDED : SHCSR_MEMFAULTPENDEDSelect := SAM_SVD.SCB.VALUE_0;
      BUSFAULTPENDED : SHCSR_BUSFAULTPENDEDSelect := SAM_SVD.SCB.VALUE_0;
      SVCALLPENDED   : SHCSR_SVCALLPENDEDSelect := SAM_SVD.SCB.VALUE_0;
      MEMFAULTENA    : SHCSR_MEMFAULTENASelect := SAM_SVD.SCB.VALUE_0;
      BUSFAULTENA    : SHCSR_BUSFAULTENASelect := SAM_SVD.SCB.VALUE_0;
      USGFAULTENA    : SHCSR_USGFAULTENASelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_19_31 : HAL.UInt13 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
...
--  use of the EPSR
   ...
   type SCB_CFSR_Register is record
      IACCVIOL       : CFSR_IACCVIOLSelect := SAM_SVD.SCB.VALUE_0;
      DACCVIOL       : CFSR_DACCVIOLSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_2_2   : HAL.Bit := 16#0#;
      MUNSTKERR      : CFSR_MUNSTKERRSelect := SAM_SVD.SCB.VALUE_0;
      MSTKERR        : CFSR_MSTKERRSelect := SAM_SVD.SCB.VALUE_0;
      MLSPERR        : CFSR_MLSPERRSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_6_6   : HAL.Bit := 16#0#;
      MMARVALID      : CFSR_MMARVALIDSelect := SAM_SVD.SCB.VALUE_0;
      IBUSERR        : CFSR_IBUSERRSelect := SAM_SVD.SCB.VALUE_0;
      PRECISERR      : CFSR_PRECISERRSelect := SAM_SVD.SCB.VALUE_0;
      IMPRECISERR    : CFSR_IMPRECISERRSelect := SAM_SVD.SCB.VALUE_0;
      UNSTKERR       : CFSR_UNSTKERRSelect := SAM_SVD.SCB.VALUE_0;
      STKERR         : CFSR_STKERRSelect := SAM_SVD.SCB.VALUE_0;
      LSPERR         : CFSR_LSPERRSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_14_14 : HAL.Bit := 16#0#;
      BFARVALID      : CFSR_BFARVALIDSelect := SAM_SVD.SCB.VALUE_0;
      UNDEFINSTR     : CFSR_UNDEFINSTRSelect := SAM_SVD.SCB.VALUE_0;
      INVSTATE       : CFSR_INVSTATESelect := SAM_SVD.SCB.VALUE_0;
      INVPC          : CFSR_INVPCSelect := SAM_SVD.SCB.VALUE_0;
      NOCP           : CFSR_NOCPSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_20_23 : HAL.UInt4 := 16#0#;
      UNALIGNED      : CFSR_UNALIGNEDSelect := SAM_SVD.SCB.VALUE_0;
      DIVBYZERO      : CFSR_DIVBYZEROSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
   ...
   type SCB_HFSR_Register is record
      ...
      VECTTBL       : HFSR_VECTTBLSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      ...
      FORCED        : HFSR_FORCEDSelect := SAM_SVD.SCB.VALUE_0;
   ...
   type SCB_DFSR_Register is record
      --  debug event generated by
      HALTED        : DFSR_HALTEDSelect := SAM_SVD.SCB.VALUE_0;
      --  debug event generated by BKPT instruction execution or a breakpoint
      --  match in FPB
      BKPT          : DFSR_BKPTSelect := SAM_SVD.SCB.VALUE_0;
      --  debug event generated by the DWT
      DWTTRAP       : DFSR_DWTTRAPSelect := SAM_SVD.SCB.VALUE_0;
      --  triggering of a Vector catch
      VCATCH        : DFSR_VCATCHSelect := SAM_SVD.SCB.VALUE_0;
      --  debug event generated because of the assertion of an external debug
      --  request
      EXTERNAL      : DFSR_EXTERNALSelect := SAM_SVD.SCB.VALUE_0;
      --  unspecified
      Reserved_5_31 : HAL.UInt27 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   subtype SCB_CTR_FORMAT_Field is HAL.UInt3;
   ...
   subtype SCB_CCSIDR_LineSize_Field is HAL.UInt3;
   subtype SCB_CCSIDR_Associativity_Field is HAL.UInt9;
   subtype SCB_CCSIDR_NumSets_Field is HAL.UInt16;
   ...
   subtype SCB_CSSELR_LEVEL_Field is HAL.UInt3;

   --  Cache Size Selection Register
   type SCB_CSSELR_Register is record
      --  selection of instruction or data cache
      IND           : CSSELR_INDSelect := SAM_SVD.SCB.DATA;
   ...
   subtype SCB_CPACR_CP_Element is HAL.UInt2;
   ...
   subtype SCB_STIR_INTID_Field is HAL.UInt9;
   ...
   type SCB_Peripheral is record
      ...
      MVFR0  : aliased HAL.UInt32;
      --  Media and VFP Feature Register 1
      MVFR1  : aliased HAL.UInt32;
      --  Media and VFP Feature Register 2
      MVFR2  : aliased HAL.UInt32;
   end record
     with Volatile;
