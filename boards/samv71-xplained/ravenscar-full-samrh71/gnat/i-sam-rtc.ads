...
package Interfaces.SAM.RTC is
   ...
   type RTC_CR_Register is record
      ...
      --  Time Event Selection
      TIMEVSEL       : CR_TIMEVSELSelect := Interfaces.SAM.RTC.MINUTE;
      --  unspecified
      Reserved_10_15 : Interfaces.SAM.UInt6 := 16#0#;
      --  Calendar Event Selection
      CALEVSEL       : CR_CALEVSELSelect := Interfaces.SAM.RTC.WEEK;
      --  unspecified
   ...
   subtype RTC_MR_EN0_Field is Interfaces.SAM.Bit;
   ...
   subtype RTC_MR_EN1_Field is Interfaces.SAM.Bit;
   ...
   type RTC_MR_Register is record
      ...
      --  RTCOUT0 OutputSource Selection
      OUT0           : MR_OUT0Select := Interfaces.SAM.RTC.NO_WAVE;
      --  PIO Line Enable
      EN0            : RTC_MR_EN0_Field := 16#0#;
      --  RTCOUT1 Output Source Selection
      OUT1           : MR_OUT1Select := Interfaces.SAM.RTC.NO_WAVE;
      --  PIO Line Enable
      EN1            : RTC_MR_EN1_Field := 16#0#;
      --  High Duration of the Output Pulse
      THIGH          : MR_THIGHSelect := Interfaces.SAM.RTC.H_31MS;
      --  unspecified
      Reserved_27_27 : Interfaces.SAM.Bit := 16#0#;
      --  Period of the Output Pulse
      TPERIOD        : MR_TPERIODSelect := Interfaces.SAM.RTC.P_1S;
      --  unspecified
...
--  time, non-BCD values) since the last read and/or they are still invalid.
   ...
   subtype RTC_IMR_TDERR_Field is Interfaces.SAM.Bit;
