...
package Interfaces.SAM.ICM is
   ...
   subtype ICM_CFG_WBDIS_Field is Interfaces.SAM.Bit;
   subtype ICM_CFG_EOMDIS_Field is Interfaces.SAM.Bit;
   subtype ICM_CFG_SLBDIS_Field is Interfaces.SAM.Bit;
   subtype ICM_CFG_BBC_Field is Interfaces.SAM.UInt4;
   subtype ICM_CFG_ASCD_Field is Interfaces.SAM.Bit;
   subtype ICM_CFG_DUALBUFF_Field is Interfaces.SAM.Bit;
   subtype ICM_CFG_UIHASH_Field is Interfaces.SAM.Bit;
   ...
   type ICM_CFG_Register is record
      --  Write Back Disable
      WBDIS          : ICM_CFG_WBDIS_Field := 16#0#;
      --  End of Monitoring Disable
      EOMDIS         : ICM_CFG_EOMDIS_Field := 16#0#;
      --  Secondary List Branching Disable
      SLBDIS         : ICM_CFG_SLBDIS_Field := 16#0#;
      --  unspecified
      Reserved_3_3   : Interfaces.SAM.Bit := 16#0#;
      --  Bus Burden Control
      BBC            : ICM_CFG_BBC_Field := 16#0#;
      --  Automatic Switch To Compare Digest
      ASCD           : ICM_CFG_ASCD_Field := 16#0#;
      --  Dual Input Buffer
      DUALBUFF       : ICM_CFG_DUALBUFF_Field := 16#0#;
      --  unspecified
      Reserved_10_11 : Interfaces.SAM.UInt2 := 16#0#;
      --  User Initial Hash Value
      UIHASH         : ICM_CFG_UIHASH_Field := 16#0#;
      --  User SHA Algorithm
      UALGO          : CFG_UALGOSelect := Interfaces.SAM.ICM.SHA1;
      --  unspecified
   ...
   subtype ICM_CTRL_ENABLE_Field is Interfaces.SAM.Bit;
   subtype ICM_CTRL_DISABLE_Field is Interfaces.SAM.Bit;
   subtype ICM_CTRL_SWRST_Field is Interfaces.SAM.Bit;
   subtype ICM_CTRL_REHASH_Field is Interfaces.SAM.UInt4;
   subtype ICM_CTRL_RMDIS_Field is Interfaces.SAM.UInt4;
   subtype ICM_CTRL_RMEN_Field is Interfaces.SAM.UInt4;

   --  Control Register
   type ICM_CTRL_Register is record
      --  Write-only. ICM Enable
      ENABLE         : ICM_CTRL_ENABLE_Field := 16#0#;
      --  Write-only. ICM Disable Register
      DISABLE        : ICM_CTRL_DISABLE_Field := 16#0#;
      --  Write-only. Software Reset
      SWRST          : ICM_CTRL_SWRST_Field := 16#0#;
      --  unspecified
      Reserved_3_3   : Interfaces.SAM.Bit := 16#0#;
   ...
   subtype ICM_SR_ENABLE_Field is Interfaces.SAM.Bit;
   subtype ICM_SR_RAWRMDIS_Field is Interfaces.SAM.UInt4;
   subtype ICM_SR_RMDIS_Field is Interfaces.SAM.UInt4;

   --  Status Register
   type ICM_SR_Register is record
      --  Read-only. ICM Enable Register
      ENABLE         : ICM_SR_ENABLE_Field;
      --  unspecified
   ...
   subtype ICM_IER_RHC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IER_RDM_Field is Interfaces.SAM.UInt4;
   subtype ICM_IER_RBE_Field is Interfaces.SAM.UInt4;
   subtype ICM_IER_RWC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IER_REC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IER_RSU_Field is Interfaces.SAM.UInt4;
   subtype ICM_IER_URAD_Field is Interfaces.SAM.Bit;
   ...
   subtype ICM_IDR_RHC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IDR_RDM_Field is Interfaces.SAM.UInt4;
   subtype ICM_IDR_RBE_Field is Interfaces.SAM.UInt4;
   subtype ICM_IDR_RWC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IDR_REC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IDR_RSU_Field is Interfaces.SAM.UInt4;
   subtype ICM_IDR_URAD_Field is Interfaces.SAM.Bit;
   ...
   subtype ICM_IMR_RHC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IMR_RDM_Field is Interfaces.SAM.UInt4;
   subtype ICM_IMR_RBE_Field is Interfaces.SAM.UInt4;
   subtype ICM_IMR_RWC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IMR_REC_Field is Interfaces.SAM.UInt4;
   subtype ICM_IMR_RSU_Field is Interfaces.SAM.UInt4;
   subtype ICM_IMR_URAD_Field is Interfaces.SAM.Bit;
   ...
   subtype ICM_ISR_RHC_Field is Interfaces.SAM.UInt4;
   subtype ICM_ISR_RDM_Field is Interfaces.SAM.UInt4;
   subtype ICM_ISR_RBE_Field is Interfaces.SAM.UInt4;
   subtype ICM_ISR_RWC_Field is Interfaces.SAM.UInt4;
   subtype ICM_ISR_REC_Field is Interfaces.SAM.UInt4;
   subtype ICM_ISR_RSU_Field is Interfaces.SAM.UInt4;
   subtype ICM_ISR_URAD_Field is Interfaces.SAM.Bit;
...
--  loaded.
   ...
   subtype ICM_DSCR_DASA_Field is Interfaces.SAM.UInt26;
   ...
   subtype ICM_HASH_HASA_Field is Interfaces.SAM.UInt25;
   ...
   subtype ICM_WPMR_WPEN_Field is Interfaces.SAM.Bit;
   subtype ICM_WPMR_WPITEN_Field is Interfaces.SAM.Bit;
   subtype ICM_WPMR_WPCREN_Field is Interfaces.SAM.Bit;
...
--  WPEN, WPITEN and WPCREN bits. Always reads as 0
   ...
   type ICM_WPMR_Register is record
      ...
      WPEN         : ICM_WPMR_WPEN_Field := 16#0#;
      --  Write Protection Interrupt Enable
      WPITEN       : ICM_WPMR_WPITEN_Field := 16#0#;
      --  Write Protection Control Enable
      WPCREN       : ICM_WPMR_WPCREN_Field := 16#0#;
      --  unspecified
   ...
   subtype ICM_WPSR_WPVS_Field is Interfaces.SAM.Bit;
   subtype ICM_WPSR_WPVSRC_Field is Interfaces.SAM.Byte;
   ...
   type ICM_Peripheral is record
      ...
      UIHVAL0 : aliased Interfaces.SAM.UInt32;
      --  User Initial Hash Value 0 Register 1
      UIHVAL1 : aliased Interfaces.SAM.UInt32;
      --  User Initial Hash Value 0 Register 2
      UIHVAL2 : aliased Interfaces.SAM.UInt32;
      --  User Initial Hash Value 0 Register 3
      UIHVAL3 : aliased Interfaces.SAM.UInt32;
      --  User Initial Hash Value 0 Register 4
      UIHVAL4 : aliased Interfaces.SAM.UInt32;
      --  User Initial Hash Value 0 Register 5
      UIHVAL5 : aliased Interfaces.SAM.UInt32;
      --  User Initial Hash Value 0 Register 6
      UIHVAL6 : aliased Interfaces.SAM.UInt32;
      --  User Initial Hash Value 0 Register 7
      UIHVAL7 : aliased Interfaces.SAM.UInt32;
      --  ICM Write Protection Mode Register
