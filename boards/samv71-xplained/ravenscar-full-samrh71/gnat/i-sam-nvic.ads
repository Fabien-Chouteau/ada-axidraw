...
package Interfaces.SAM.NVIC is
   ...
   --  Interrupt Set Enable Register n
   type NVIC_ISER_Registers is array (0 .. 7) of Interfaces.SAM.UInt32;

   --  Interrupt Clear Enable Register n

   --  Interrupt Clear Enable Register n
   type NVIC_ICER_Registers is array (0 .. 7) of Interfaces.SAM.UInt32;

   --  Interrupt Set Pending Register n

   --  Interrupt Set Pending Register n
   type NVIC_ISPR_Registers is array (0 .. 7) of Interfaces.SAM.UInt32;

   --  Interrupt Clear Pending Register n

   --  Interrupt Clear Pending Register n
   type NVIC_ICPR_Registers is array (0 .. 7) of Interfaces.SAM.UInt32;

   --  Interrupt Active bit Register n

   --  Interrupt Active bit Register n
   type NVIC_IABR_Registers is array (0 .. 7) of Interfaces.SAM.UInt32;

   --  Interrupt Priority Register (8Bit wide) n

   --  Interrupt Priority Register (8Bit wide) n
   type NVIC_IP_Registers is array (0 .. 239) of Interfaces.SAM.Byte;

   subtype NVIC_STIR_INTID_Field is Interfaces.SAM.UInt9;
