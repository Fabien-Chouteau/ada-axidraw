...
private
   ...
   Transceiver : USART renames USART_3;

   Transceiver_AF : constant GPIO_Alternate_Function := GPIO_AF_USART3_7;

   TX_Pin  : GPIO_Point := PD8;
   RX_Pin  : GPIO_Point := PD9;
...
--     RTS_Pin : GPIO_Point := PA1;
   ...
   Tx_Stream : constant DMA_Stream_Selector := Stream_3;

   DMA_Tx_IRQ : constant Ada.Interrupts.Interrupt_Id := DMA1_Stream3_Interrupt;
